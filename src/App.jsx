...
function saveData(data) {
  try { localStorage.setItem("habla-data", JSON.stringify(data)); } catch(e) { console.error(e); }
}
...
export default function App() {
  ...
  useEffect(() => { const d = loadData(); setData(d); setLoaded(true); }, []);
  ...
  return (
    <div style={{
      ...
      {view === "log" && <>
        ...
        {data.sessions.length > 0 && (
          <button className="btn btn-ghost btn-sm" style={{ margin: "10px auto", display: "block" }} onClick={() => {
